...
import { LayoutDashboard, BookOpen, Calendar, ClipboardList, BarChart2, UserCircle } from 'lucide-react'
...
const navItems = [
  ...
  { label: 'My Profile',           path: '/student/profile',     icon: <UserCircle className="w-5 h-5" /> },
]

export default function StudentPortal() {
  return (
    <PortalLayout navItems={navItems} inactivityMinutes={10}>
      <Routes>
